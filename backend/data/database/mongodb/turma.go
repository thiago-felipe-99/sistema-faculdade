...
func (bd TurmaBD) Inserir(*entidades.Turma) *errors.Aplicação {
...
func (bd TurmaBD) Atualizar(id, *entidades.Turma) *errors.Aplicação {
...
func (bd TurmaBD) Pegar(id) (*entidades.Turma, *errors.Aplicação) {
