...
func (bd TurmaBD) Atualizar(id, *entidades.Turma) *erros.Aplicação {
...
func (bd TurmaBD) Pegar(id) (*entidades.Turma, *erros.Aplicação) {
...
func (bd TurmaBD) Deletar(id) *erros.Aplicação {
