...
// MariaDB.
func (bd AdministrativoBD) Atualizar(id, *entidades.Administrativo) *erros.Aplicação {
...
func (bd AdministrativoBD) Pegar(id) (*entidades.Administrativo, *erros.Aplicação) {
...
func (bd AdministrativoBD) Deletar(id) *erros.Aplicação {
